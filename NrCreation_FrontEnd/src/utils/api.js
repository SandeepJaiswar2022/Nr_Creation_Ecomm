...
export const API_BASE_URL = "https://nrcreationdiary.qzz.io/api/nr-creation/v1"; // Changed to http
// export const API_BASE_URL = "http://192.168.0.103:8080/api/nr-creation/v1"; // Changed to http
// export const API_BASE_URL = "https://nrcreation-v4.onrender.com/api/nr-creation/v1";
...
api.interceptors.response.use(
  ...
  async (error) => {
    ...
    if (error.response?.status === 401 && !originalRequest._retry) {
      ...
      try {
        // console.log("refresh the Access-Token if it is expired");
