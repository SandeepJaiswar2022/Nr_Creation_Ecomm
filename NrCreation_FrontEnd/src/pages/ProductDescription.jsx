  ...
  const mockReviews = [
    {
      ...
      rating: 5,
      comment:
        "Excellent product! The quality is outstanding and it fits perfectly. Would definitely recommend.",
    ...
    },
    {
      ...
      rating: 4,
      comment:
        "Great product overall. The only minor issue was the delivery time, but the product itself is worth it.",
      images: [],
    },
    {
      ...
      rating: 5,
      comment:
        "Absolutely love this product! The design is beautiful and the material is high quality.",
          ...
          <div className="flex gap-4 h-full">
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-2 gap-2 pt-4">
                <button
                  className="flex justify-center items-center md:p-3.5 max-sm:py-1.5 max-sm:px-0.5 font-medium text-white bg-[#871845] hover:bg-[#611031]"
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              <span className="text-2xl font-bold text-[#871845]">
                ₹{product?.price}
              </span>
            ...
            <div className="text-lg font-bold flex">
              ...
              <p className="ml-2 bg-orange-700 text-white py-0.5 px-2">
                {product?.inventory}
              </p>
            </div>
                  ...
                  >
                    <div className="px-6">
                      <div className="">
                        <div className="h-[1px] w-full bg-[#871845]"></div>
                        <p className="text-gray-600 py-5">
                          We accept returns within 7 days of delivery. The
                    ...
                    <div className="px-6">
                      <div className="">
                        ...
                        <p className="text-gray-600 py-5">
                          ...
                          delivery (additional charges apply) takes 1-2 business
                          days. We ship to all major cities in India.
                        </p>
                      </div>
                    </div>
                  </motion.div>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="grid rounded-full w-full gap-2 grid-cols-3">
              <TabsTrigger className="rounded-full" value="description">
                Full Description
              </TabsTrigger>
              <TabsTrigger className="rounded-full" value="specifications">
                Specifications
              </TabsTrigger>
              <TabsTrigger className="rounded-full" value="reviews">
                Reviews
              </TabsTrigger>
            </TabsList>
