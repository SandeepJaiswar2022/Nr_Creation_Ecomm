...
const ProductManagement = () => {
  ...
  const { products, loading, categories, totalPages } = useSelector(
    (store) => store.product
  );
  ...
  useEffect(() => {
    ...
    selectedFilters.sortOrFeaturedOrNewest,
  ]);
              ...
              <div className="space-y-3 pt-3 border-t">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      navigate(`/admin/products/images/${product?.id}`)
                    }
                    className="flex-1 text-xs px-2 py-1"
                  >
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-gray-50 border-b">
                    <th className="text-left py-3 sm:py-4 px-3 sm:px-6 text-sm sm:text-base whitespace-nowrap">
                      Image
                    </th>
                    <th className="text-left py-3 sm:py-4 px-3 sm:px-6 text-sm sm:text-base whitespace-nowrap">
                      Product ID
                ...
                <tbody>
                  {products.map((product) => (
                    ...
                    >
                      ...
                      <td className="py-3 sm:py-4 px-3 sm:px-6 text-sm sm:text-base whitespace-nowrap">
                        {product?.id}
                      </td>
