...
const slides = [
  {
    ...
    subtitle:
      "Explore our latest collection of trendy fashion for men and women.",
    cta: "Shop Now",
    link: "/men",
  },
  {
            ...
            >
              <Link to="/men">
                ...
                <div className="absolute bottom-8 left-8 text-white">
                  ...
                  <Button
                    variant="outline"
                    className="text-black py-6 rounded-none font-semibold text-lg border-white hover:bg-white hover:text-black transition-colors duration-300"
                  >
